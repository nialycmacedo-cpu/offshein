          ...
          <div className="flex items-center justify-center min-h-[500px]">
            <Card className="w-full max-w-xl p-8 shadow-lg border-2 border-gray-300 rounded-2xl">
              <div className="space-y-6" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="bg-[#fff3cd] border border-[#ffa500] rounded-lg p-4 space-y-2">
                  <h3 className="font-bold text-[#dc2626] text-center">
                ...
                <div className="space-y-4">
                  <div className="space-y-2">
                    ...
                    {errors.tipoChave && (
                      <p className="text-sm text-red-600">{errors.tipoChave.message}</p>
                    )}
                  </div>
                  ...
                  <div className="space-y-2">
                    ...
                    {errors.chavePixValue && (
                      <p className="text-sm text-red-600">{errors.chavePixValue.message}</p>
                    )}
                  ...
                  <Button 
                    type="submit"
                    className="w-full bg-black hover:bg-gray-800 text-white py-3 rounded-md text-sm font-bold mt-6"
                  >
                    Confirmar Dados PIX
                  </Button>
                </div>
        ...
        <DialogContent className="sm:max-w-md bg-white p-8">
          <div className="space-y-6 text-center">
            <div className="space-y-4">
              ...
              <div className="bg-[#fff3cd] border border-[#ffa500] rounded-lg p-4">
                <h3 className="font-bold text-[#dc2626] mb-2">
                  Você receberá R$ 690,00 via PIX
                </h3>
                <p className="text-sm text-gray-800">
              ...
              <div className="bg-white border-2 border-gray-300 rounded-lg p-6 space-y-3">
