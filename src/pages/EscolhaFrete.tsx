      ...
      <div className="flex-1 p-3 sm:p-4 pt-4 sm:pt-8">
        <div className="max-w-4xl mx-auto space-y-4 sm:space-y-6">
          ...
          <div className="flex items-center justify-center min-h-[300px] sm:min-h-[500px]">
            <Card className="w-full max-w-2xl p-4 sm:p-8 shadow-lg border-2 border-gray-300 rounded-xl sm:rounded-2xl bg-white">
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="flex items-center justify-center gap-4 sm:gap-8 pb-4 sm:pb-6 border-b">
                  ...
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    ...
                    <span className="text-xs sm:text-sm font-semibold">Frete</span>
                  </div>
                </div>
                ...
                <div className="space-y-3 sm:space-y-4">
                      ...
                      >
                        <div className="flex items-center justify-between gap-2">
                          <div className="flex items-center gap-2 sm:gap-3 flex-1 min-w-0">
                            <RadioGroupItem value={opcao.id} id={opcao.id} className="shrink-0" />
                            <Label
                              htmlFor={opcao.id}
                          ...
                          <div className="font-bold text-gray-800 text-sm sm:text-base shrink-0">
                            R${" "}
                  ...
                  <Button
                    ...
                    className="w-full bg-[#00c853] hover:bg-[#00a844] text-white py-2.5 sm:py-3 text-xs sm:text-sm font-bold rounded-md mt-4 sm:mt-6"
                  >
                    IR PARA O PAGAMENTO
                  </Button>
                </div>
                ...
                <div className="bg-[#fff3cd] border-2 border-[#ffa500] rounded-lg p-3 sm:p-4 space-y-2">
                  <div className="flex items-start gap-2">
                    ...
                    <div className="flex-1 space-y-2">
                      ...
                      {pixData && (
                        <div className="bg-white border border-gray-300 rounded p-2 sm:p-3 mt-2">
